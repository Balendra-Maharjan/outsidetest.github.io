...
function initSlickCarousel() {
	jQuery('.benefecial-slider').slick({
		rows: 0,
		slidesToShow: 1,
		arrows: false,
		mobileFirst: true,
	...
	ResponsiveHelper.addRange({
		'..767': {
			...
			off: function () {
				jQuery('.news-hold').tabset('destroy');
			},
		},
	});
	...
	ResponsiveHelper.addRange({
		'..767': {
			...
			off: function () {
				jQuery('.gallery-hold').tabset('destroy');
			},
		},
	});
}
